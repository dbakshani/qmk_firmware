...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_split_3x6_3(
      ...
      _______, KC_F10 , KC_F1  , KC_F2  , KC_F3  , _______,                   KC_BSLS,  KC_1   , KC_2   , KC_3   , _______, _______, 
                                          KC_PAUS, _______, _______,  DVK_MINS, KC_0 ,  DVK_DOT
  ),
  ...
  [_RAISE] = LAYOUT_split_3x6_3(
      ...
      _______, _______, KC_EXLM, KC_AT  , KC_HASH, KC_TILD,                   KC_PIPE, KC_LPRN, KC_RPRN, _______, KC_BSPC, _______,
                                          _______,DVK_UNDS, _______, _______, _______, _______
  ),
