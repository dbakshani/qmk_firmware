...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LGUI, KC_LALT, LOWER, LT(_NAVIGATION, KC_SPC), LT(_NAVIGATION, KC_SPC),  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_NAVIGATION] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, KC_PGUP, _______, _______,  _______, KC_RIGHT, _______,
    _______, KC_END , _______, _______, KC_PGUP, KC_HOME, KC_PGDN, KC_LEFT, _______,  _______, _______, _______,
    _______, _______, _______, KC_DOWN, KC_UP  , KC_SPC , KC_PGDN, _______, _______,  _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______
)
